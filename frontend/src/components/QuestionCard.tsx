...
const OptionCard = ({ text, label }) => {
    return (
        <button className="w-full text-left transition-all duration-200 group">
            <div className="min-h-[4rem] p-4 bg-white rounded-lg border border-gray-200 hover:bg-blue-50 hover:border-blue-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-sm">
                <div className="flex gap-3">
                    ...
                    <span className="text-gray-700 py-1">{text}</span>
                </div>
            </div>
        </button>
    );
